...
echo '<li>';
printf(__('Spanish by %1$sRafo&copy; Computaci&oacute;n & Web%2$s', 'scoper'), "<a href='http://www.rafo.cl/' target='_blank'>", '</a>');
echo '</li><li>';
printf(__('French by %1$sChryjs%2$s', 'scoper'), "<a href='http://chryjs.free.fr' target='_blank'>", '</a>');
echo '</li><li>';
printf(__('Italian by %1$sAlberto Ramicciotti%2$s', 'scoper' ), "<a href='http://obertfsp.com' target='_blank'>", '</a>');
echo '</li></ul><p>';
